<?php
  ...
  if(filter_var($email, FILTER_VALIDATE_EMAIL)){
    ...
    $ap_paterno = $externo['ap_paterno'];
    $ap_materno = $externo['ap_materno'];
    $procedencia = $externo['procedencia'];
    $email_doc = $externo['email_ex'];
    $telefono = $externo['telefono'];
    $participacion=$externo['participacion'];
  }else{
    echo '<script>alert("Error al ingresar a la pagina");window.location="pag_admin_tables_ex.php";</script>';
  }
