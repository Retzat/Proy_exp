  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tercer registro</h1><!-- Aqui se pone el titulo -->
          </div>          
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Tercer registro de asistencia</h3>          
        </div>
        <div class="card-body">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label for="inputEmail3" class="col-sm-2 col-form-label">Codigo QR</label>
                            <input type="text" name="text3" id="qr_code" readonny="" placeholder="Escanea tu QR" class="form_control">                            
                        </div>                       
                      </div>
                   </div>
                  </div>
                  <div class="card-footer">
                  <button type="submit" class="btn btn-info" name="add_reg3">Generar tercer registro</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
