...
<script>
  $(function () {
    ...
    $('.duallistbox').bootstrapDualListbox({filterPlaceHolder:"Filtro",moveSelectedLabel:"Mover",moveAllLabel:"Mover todo",
      removeAllLabel:"Remover todo",removeSelectedLabel:"Remover",infoText:"Mostrando todos {0}",
      infoTextFiltered:"<span class='badge badge-warning'>Filtrado</span> {0} de {1}",infoTextEmpty:"Lista vacia",
      filterTextClear:"Mostrar todo",filterPlaceHolder:"Filtro",moveSelectedLabel:"Mover",moveAllLabel:"Mover todo",}),
